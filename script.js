...
function plusOrMinus(element) {
    const parent = element.closest('.main__product'),
        /* closest() o'rab turgan elementga ulanamiz */
        parentId = parent.getAttribute('id'),
        /* O'rab turgan element attributini "ID" olamiz */
        out = parent.querySelector('.main__product-num'),
        /* O'rab turgan elementdan miqdorga ulanamiz */
        price = parent.querySelector('.main__product-price span'),
        /* O'rab turgan elementdan narxga ulanamiz */
        kcall = parent.querySelector('.main__product-kcall span'),
        /* O'rab turgan elementdan kaloriyaga ulanamiz */
